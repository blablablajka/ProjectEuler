...
{4, 52, 8, 83, 97, 99, 16, 7, 97, 57, 32, 26, 26, 26, 79, 33, 27, 98, 66},
...
{1, 70, 54, 71, 83, 51, 54, 69, 16, 92, 33, 48, 61, 43, 52, 1, 89, 19, 67, 48}};
   for(int i = 0; i < 17; ++i)
   {
       for(int j = 0; j < 17; ++j)
       {
            x = m[i][j] * m[i][j + 1] * m[i][j + 2] * m[i][j + 3];
            cout<<max<<" ";
            if (x > max)
                max = x;
            x = m[i][j] * m[i + 1][j] * m[i + 2][j] * m[i + 3][j];
            cout<<max<<" ";
            if (x > max)
                max = x;
            x = m[i][j] * m[i + 1][j + 1] * m[i + 2][j + 2] * m[i + 3][j + 3];
            cout<<max<<" ";
            if (x > max)
                max = x;
            x = m[i][j] * m[i - 1][j - 1] * m[i - 2][j - 2] * m[i - 3][j - 3];
